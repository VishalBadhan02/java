    ...
    public void employee() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            switch (month) {
                case 1:
                    month = 1;
                    System.out.println("Salary of " + employee[i].firstname + " with " + employee[i].bonus + " Bonus : "
                            + (salary = employee[i].basesalary * 31 + employee[i].bonus));
                    break;
                case 2:
                    month = 2;
                    System.out.println("Salary of " + employee[i].firstname + " with " + employee[i].bonus + " Bonus : "
                            + (salary = employee[i].basesalary * 28 + employee[i].bonus));
                    break;
                case 3:
                    month = 3;
                    System.out.println("Salary of " + employee[i].firstname + " with " + employee[i].bonus + " Bonus : "
                ...
                case 4:
                    month = 4;
                    System.out.println("Salary of " + employee[i].firstname + " with " + employee[i].bonus + " Bonus : "
                            + (salary = employee[i].basesalary * 30 + employee[i].bonus));
                    break;
                case 5:
                    month = 5;
                    System.out.println("Salary of " + employee[i].firstname + " with " + employee[i].bonus + " Bonus : "
